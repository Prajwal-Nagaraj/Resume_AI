...
export const JobCard: React.FC<JobCardProps> = ({ job, onClick, isSelected, onSelectionChange }) => {
  ...
  const handleTailorClick = (e: React.MouseEvent) => {
    e.stopPropagation();
    // Handle tailor resume functionality
    console.log('Tailor resume for job:', job.id);
  };
      ...
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
        ...
        <div className="flex flex-col space-y-3 lg:min-w-[200px]">
          ...
          <button 
            ...
            className="inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-gray-200"
          >
            Save Job
          </button>
          ...
          <button 
            ...
            className="inline-flex items-center justify-center px-6 py-3 border border-blue-300 text-blue-600 font-medium rounded-lg hover:bg-blue-50 hover:border-blue-400 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-blue-200"
          >
            Tailor Resume
          </button>
        </div>
